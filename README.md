...
Чат-приложение, использующее API OpenRouter для взаимодействия с различными моделями искусственного интеллекта с системой аутентификации по ключу и PIN коду.
